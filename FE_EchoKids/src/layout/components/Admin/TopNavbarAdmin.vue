            ...
            <div class="top-logo">
              <a href="index.html" class="logo">
                ...
                <div class="iq-dark-logo">
                  <img
                    src="/Admin/images/logo-dark.gif"
                    class="img-fluid"
                    alt=""
                  />
                </div>
          ...
          <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="navbar-left">
              <ul id="topbar-data-icon" class="d-flex p-0 topbar-menu-icon">
                ...
                <li>
                  <a href="e-commerce-product-list.html" class="nav-link"
                    ...
                    <ul class="m-0 pl-3 pr-3 pb-3">
                      ...
                      <li class="iq-bg-primary-hover rounded">
                        <a
                          ...
                          class="nav-link router-link-exact-active router-link-active pr-2"
                          ><i class="ri-home-3-line pr-2"></i>Dashboard-1</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a href="chat.html" class="nav-link"
                          ><i class="ri-message-line pr-2"></i>Chat</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a href="calendar.html" class="nav-link"
                          ><i class="ri-calendar-2-line pr-2"></i>Calendar</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a href="profile.html" class="nav-link"
                          ><i class="ri-profile-line pr-2"></i>Profile</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a href="todo.html" class="nav-link"
                          ><i class="ri-chat-check-line pr-2"></i>Todo</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a href="app/index.html" class="nav-link"
                          ><i class="ri-mail-line pr-2"></i>Email</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a href="e-commerce-product-list.html" class="nav-link"
                          ><i class="ri-message-line pr-2"></i>Product
                          Listing</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a
                          ...
                          class="nav-link"
                          ><i class="ri-file-list-line pr-2"></i>Product
                          Details</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a href="pages-faq.html" class="nav-link"
                          ><i class="ri-compasses-line pr-2"></i>Faq</a
                        >
                      </li>
                      <li class="iq-bg-primary-hover rounded">
                        <a href="form-wizard.html" class="nav-link"
                          ><i class="ri-clockwise-line pr-2"></i>Form-wizard</a
                        >
                      </li>
                    </ul>
                  </div>
              ...
              <ul class="navbar-nav ml-auto navbar-list">
                <li class="nav-item">
                  <a
                    ...
                    href="#"
                    ><img
                      src="/Admin/images/small/flag-01.png"
                      alt="img-flaf"
                  ...
                  <div class="iq-sub-dropdown">
                    <a class="iq-sub-card" href="#"
                      ><img
                        src="/Admin/images/small/flag-02.png"
                        alt="img-flaf"
                    ...
                    <a class="iq-sub-card" href="#"
                      ><img
                        src="/Admin/images/small/flag-03.png"
                        alt="img-flaf"
                        class="img-fluid mr-2"
                      />Spanish</a
                    >
                    <a class="iq-sub-card" href="#"
                      ><img
                        src="/Admin/images/small/flag-04.png"
                        alt="img-flaf"
                        class="img-fluid mr-2"
                      />Italian</a
                    >
                    <a class="iq-sub-card" href="#"
                      ><img
                        src="/Admin/images/small/flag-05.png"
                        alt="img-flaf"
                        class="img-fluid mr-2"
                      />German</a
                    >
                    <a class="iq-sub-card" href="#"
                      ><img
                        src="/Admin/images/small/flag-06.png"
                        alt="img-flaf"
                        class="img-fluid mr-2"
                      />Japanese</a
                    >
