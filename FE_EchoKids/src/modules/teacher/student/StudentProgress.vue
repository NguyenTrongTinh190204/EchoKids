      ...
      <div class="col-12 col-lg-7">
        <div class="card border-0 shadow-sm rounded h-100">
          <div class="card-body">
            ...
            <div
              class="border rounded p-3 mb-3 lesson-item"
      ...
      <div class="col-12 col-lg-5">
        <div class="card border-0 shadow-sm rounded h-100">
          <div class="card-body">
            ...
            <div class="border rounded p-3 mb-3 teacher-note-card">
              <p class="mb-0">
            ...
            <div class="border rounded p-3 teacher-note-card">
              <p class="mb-0">
            ...
            <button
              class="btn btn-primary w-100 rounded mt-4"
              @click="goToReport"
            >
