    ...
    <div class="container-fluid p-0 mb-5">
      <div class="owl-carousel header-carousel position-relative">
        <div class="owl-carousel-item position-relative">
          <img class="img-fluid" src="/public/Client/images/carousel-1.jpg" alt="" />
          <div
        ...
        <div class="owl-carousel-item position-relative">
          <img class="img-fluid" src="/public/Client/images/carousel-2.jpg" alt="" />
          <div
            class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
            style="background: rgba(0, 0, 0, 0.35)"
          >
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-10 col-lg-7">
                  ...
                  <p class="fs-5 fw-medium text-white mb-4 pb-2">
                    Theo dõi tiến độ học tập, xem lỗi phát âm thường gặp và nhận
                    gợi ý bài luyện phù hợp cho trẻ mỗi ngày.
                  </p>
  ...
  <div class="container">
    <div class="row g-5 align-items-center">
      <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
        ...
        <p>
          EchoKids là nền tảng hỗ trợ trẻ em luyện phát âm tiếng Việt thông qua
          hình ảnh, âm thanh, video khẩu hình và các bài tập tương tác thú vị.
          Hệ thống giúp trẻ nhận biết âm, luyện nói và cải thiện kỹ năng giao
          tiếp mỗi ngày.
        </p>

        <p class="mb-4">
          Với công nghệ AI chấm điểm phát âm, phụ huynh và giáo viên có thể dễ
          dàng theo dõi tiến độ học tập, phát hiện lỗi phát âm thường gặp và
          nhận gợi ý bài luyện phù hợp cho từng trẻ.
        </p>
...
<div class="container-xxl py-5">
  <div class="container">
    ...
    >
      ...
      <p>
        EchoKids được xây dựng với sự hỗ trợ từ giáo viên, chuyên gia ngôn ngữ
        và phụ huynh nhằm giúp trẻ cải thiện khả năng phát âm tiếng Việt một cách
        tự nhiên, vui vẻ và hiệu quả hơn mỗi ngày.
      </p>
    </div>
      ...
      <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="team-item position-relative">
          ...
          <div class="team-text">
            ...
            <p>Hỗ trợ phân tích lỗi phát âm và xây dựng lộ trình luyện tập phù hợp</p>
      ...
      <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
        <div class="team-item position-relative">
          ...
          <div class="team-text">
            ...
            <p>Nhận diện giọng nói, chấm điểm phát âm và gợi ý bài luyện phù hợp</p>
...
<div class="container-xxl py-5">
  <div class="container">
    ...
    >
      ...
      <p>
        EchoKids luôn ghi nhận sự cố gắng của các bé trong quá trình luyện phát âm.
        Đây là những học sinh có nhiều tiến bộ, duy trì streak học tập tốt và hoàn thành xuất sắc các bài luyện.
      </p>
    </div>
